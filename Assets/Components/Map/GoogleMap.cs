...
public class GoogleMap : MonoBehaviour {
    ...
    public string GoogleApiKey = "AIzaSyD_lCc7joX14k6-LSwAJOWayQqVTljgxb4";
    public bool loadOnStart = true;
    public bool autoLocateCenter = true;
    public GoogleMapLocation centerLocation;
    public int zoom;
    public MapType mapType;
    public int sizeX = 720;
    public int sizeY = 1280;
    ...
    public IEnumerator _Refresh() {
        ...
        qs += "&size=" + UnityWebRequest.UnEscapeURL(string.Format("{0}x{1}", sizeX, sizeY));
